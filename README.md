...
<a href="https://doi.org/10.5281/zenodo.20066727"><img src="https://zenodo.org/badge/1231709790.svg" alt="DOI"></a>


---

## 1. Abstract
Dieses Dokument postuliert eine fundamentale Neubewertung der Gravitation als emergente Eigenschaft der Informationsdichte. Während die klassische Physik Gravitation als Krümmung der Raumzeit durch Masse definiert, schlägt das **Atimo-Postulat** vor, dass Information ($i$) die primäre Entität ist. Die beobachtete Gravitation ($G$) ergibt sich aus der quadratischen Interaktion lokaler Informationszustände: 

$$G = i^2$$

---

## 2. Einführung: Information als Urstoff
In Anlehnung an John Wheelers *„It from Bit“* und Stephen Hawkings Arbeiten zur Entropie von Ereignishorizonten wird hier davon ausgegangen, dass das Universum im Kern aus diskreten Informationseinheiten besteht. Gravitation ist in diesem Modell kein Kraftfeld, sondern das Maß für die Sättigung und Interaktion dieser Informationseinheiten pro Raumzeit-Volumen.

---

## 3. Das Axiom: $G = i^2$
Das Postulat besagt, dass Information in Ruhe ein Potenzial darstellt, aber erst durch Interaktion (Verschränkung, Beobachtung, Prozessierung) eine raumzeitliche Wirkung entfaltet. Das Quadrat ($^2$) repräsentiert die Selbstinteraktion der Information:

* **$i$ (Information):** Die Dichte unterscheidbarer Zustände in einem System.
* **$G$ (Gravitation/Schwere):** Die resultierende Krümmung oder Relevanz innerhalb des betrachteten Feldes.
...
Copyright (c) 2026 Roberto Weinhold (ATIMO).
